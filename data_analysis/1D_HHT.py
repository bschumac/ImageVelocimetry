...
from functions.TST_fun import find_interval, create_tst_mean, randomize_find_interval
import h5py
import numpy as np
...
file = h5py.File('/home/benjamin/Met_ParametersTST/Pre_Fire/Tier03/Optris_data/Tb_stab_cut_red_27Hz.nc','r')
#file = h5py.File(datapath+'Tb_stab_pertub_py_virdris.nc','r')
tb = file.get("Tb")
tb = np.array(tb)
...
ret_lst = randomize_find_interval(data = tb,rec_freq = 27)



pixel = tb[:,150,150]
test = find_interval(pixel,27)