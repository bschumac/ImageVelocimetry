...
datapath = "/home/benjamin/Met_ParametersTST/T1/Tier01/12012019/Optris_data/"

file = h5py.File(datapath+'Flight03_O80_Tb_org_20Hz.nc','r')
tb= file.get("Tb")
...
plt.imshow(std_pertub)
plt.colorbar()
plt.savefig(datapath+str("std_Tb_Org_20Hz")+".png",dpi=600,bbox_inches='tight',pad_inches = 0,transparent=False)
plt.close()
