...
outpath = "/home/benjamin/Met_ParametersTST/T1/Tier01/12012019/Optris_data/Flight03_O80_1616_png/"
...
for i in range(18000,68000, 13):
        ...
        plt.savefig(outpath+str(counter)+".png",dpi=my_dpi,bbox_inches='tight',pad_inches = 0,transparent=False)
        plt.close()
        counter +=1
