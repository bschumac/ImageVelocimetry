...
def correlateTC(base_TC, TCs_signal, min_corr_time, max_corr_time, TC_nans = [1,12] , numberof_TCs = 12, subsamp_feq = 10):
    ...
    for j in range(0,len(base_TC_signal)-40,20):
        ...
        for i in range(0,20):
            corr_TC1 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[0][j:j+20])
            corr_TC2 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[1][j:j+20])
            corr_TC3 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[2][j:j+20])
            corr_TC4 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[3][j:j+20])
            corr_TC5 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[4][j:j+20])
            corr_TC6 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[5][j:j+20])
            corr_TC7 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[6][j:j+20])
            corr_TC8 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[7][j:j+20])
            corr_TC9 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[8][j:j+20])
            corr_TC10 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[9][j:j+20])
            corr_TC11 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[10][j:j+20])
            corr_TC12 = np.corrcoef(base_TC_signal[j+i:j+20+i],TCs_signal[11][j:j+20])
        ...
        if picked_TC == 12 :
            corr_time = corr_lst_TC12.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(12,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        if picked_TC == 11:
            corr_time = corr_lst_TC11.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(11,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 10:
            corr_time = corr_lst_TC10.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(10,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 9:
            corr_time = corr_lst_TC9.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(9,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 8:
            corr_time = corr_lst_TC8.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(8,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 7:
            corr_time = corr_lst_TC7.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(7,base_TC)
            WS = distance/(corr_time/subsamp_feq)    
        elif picked_TC == 6:
            corr_time = corr_lst_TC6.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(6,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 5:
            corr_time = corr_lst_TC5.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(5,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 4:
            corr_time = corr_lst_TC4.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(4,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 3:
            corr_time = corr_lst_TC3.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(3,base_TC)
            WS = distance/(corr_time/subsamp_feq) 
        elif picked_TC == 2:
            corr_time = corr_lst_TC2.index(max_corrval)+min_corr_time
            distance, WD = TCcalcdistangle(2,base_TC)
            WS = distance/(corr_time/subsamp_feq)
        elif picked_TC == 1:
            corr_time = corr_lst_TC1.index(max_corrval)+min_corr_time
    ...
    return([WS_lst,WD_lst,picked_tc_lst,corr_time_lst,TC_corr_df])
